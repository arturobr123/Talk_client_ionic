...
export class FirebaseProvider {
  ...
  constructor(public angularfire: AngularFire, public loadingProvider: LoadingProvider, public dataProvider: DataProvider) {
    console.log("Initializing Firebase Provider");
  }

  // Send friend request to userId.
  sendFriendRequest(userId) {
    let loggedInUserId = window.localStorage['uid_Firebase'];
  ...
  cancelFriendRequest(userId) {
    let loggedInUserId = window.localStorage['uid_Firebase']; //firebase.auth().currentUser.uid
    this.loadingProvider.show();
